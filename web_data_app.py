...
def book_data():
    ...
    book_data['Prices (reduced by 25%)'] = book_data['Prices']*0.75
...
def learn():
    """
    This route will display text saying what I have learned in ENSF 692.
    """
    return "One thing I learned in ENSF 692 is list comprehensions, which I found very useful. I also appreciate its very short syntax."
